...
check_cgroup_hierarchy() {
    return 0
    [ -d "/sys/fs/cgroup/cpu/libvirt/qemu/$1" ] && \
    [ -d "/sys/fs/cgroup/devices/libvirt/qemu/$1" ] && \
    [ -d "/sys/fs/cgroup/cpuacct/libvirt/qemu/$1" ] && \
    [ -d "/sys/fs/cgroup/memory/libvirt/qemu/$1" ] && \
    [ -d "/sys/fs/cgroup/blkio/libvirt/qemu/$1" ] && \
    [ -d "/sys/fs/cgroup/freezer/libvirt/qemu/$1" ] && \
    [ -d "/sys/fs/cgroup/cpuset/libvirt/qemu/$1" ]
    return $?
}
